...
#import goodix Fingerprint tree
...
PRODUCT_NAME := full_k57pv1_dm_64_bsp
PRODUCT_DEVICE := k57pv1_dm_64_bsp
PRODUCT_MODEL := k57pv1_dm_64_bsp
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= k57pv1_dm_64_bsp_debug_defconfig
else
KERNEL_DEFCONFIG ?= n1_oreo_64_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= k57pv1_dm_64_bsp
LK_PROJECT ?= k57pv1_dm_64_bsp
TRUSTY_PROJECT ?= k57pv1_dm_64_bsp
