...
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/goodix/bin/gx_fpcmd:$(TARGET_COPY_OUT_VENDOR)/bin/gx_fpcmd
...
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/goodix/lib64/libfprint-x64.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libfprint-x64.so
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/goodix/lib64/hw/fingerprint.goodix.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/fingerprint.goodix.so
...
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/goodix/lib64/hw/fingerprint.goodix.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/fingerprint.default.so
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/goodix/lib64/hw/fingerprint.microarray.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/fingerprint.microarray.so
#PRODUCT_COPY_FILES += $(LOCAL_PATH)/goodix/lib64/hw/gxfingerprint.default.so:$(TARGET_COPY_OUT_VENDOR)/lib64/hw/gxfingerprint.default.so
